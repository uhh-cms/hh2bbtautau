...
from hbt.calibration.met import recoil_corrected_met

from columnflow.util import maybe_import

from hbt.util import IF_DATASET_HAS_HIGGS, IF_DATASET_HAS_TOP, IF_DATASET_IS_DY, IF_DATASET_HAS_SINGLE_BOSON
...
@reducer(
    uses={
        ...
        IF_DATASET_IS_DY(gen_dy_lookup),
        IF_DATASET_HAS_SINGLE_BOSON(gen_dilepton, recoil_corrected_met),
    },
    produces={
        cf_default,
        IF_DATASET_HAS_HIGGS(gen_higgs_lookup),
...
def default(self: Reducer, events: ak.Array, selection: ak.Array, **kwargs) -> ak.Array:
    ...
    # TODO: as soon as our selection depends on met, recoil_corrected_met should be part of the default calibration
