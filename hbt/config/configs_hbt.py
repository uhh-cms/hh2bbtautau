...
def add_config(
    ...
    if run == 2:
        ...
        # UHH dy weight
        add_external("dy_weight_sf_uhh", ("/data/dust/user/alvesand/analysis/hh2bbtautau_data/hbt_store/analysis_hbt/hbt.ExportDYWeights/22pre_v14/prod10_amcatnlo/hbt_corrections_mumu__dyc_eq2j__os_njets-dilep_pt.json.gz", "v1"))  # noqa: E501
