...
def add_config(
    ...
    if run == 2:
        ...
        add_external("dy_weight_sf", ("/data/dust/user/alvesand/analysis/hh2bbtautau_data/hbt_store/analysis_hbt/hbt.ExportDYWeights/22pre_v14__22post_v14__23pre_v14__23post_v14/prod20_vbf/hbt_corrections.json.gz", "v1"))  # noqa: E501
